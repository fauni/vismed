...
public class OperacionesDescargaRealizadasNegativas extends AsyncTask<String, String, String>{
	private ProgressDialog DialogLogin;
	protected Activity activity;
	protected String apm;

	VariablesUrl var= new VariablesUrl();
	String link =var.function_descargar_negativas_realizadas();
	String servidor;
	...
	public OperacionesDescargaRealizadasNegativas(Activity act, String apm)
	{
        super();
        this.activity=act;
        this.apm=apm;
                ...
                JSONArray  jArray = new JSONArray(jsonObject.getJSONArray("visita").toString());
					for(int i=0;i<jArray.length();i++) {
						...
						boletaje.add(new Boletaje(
								...
								json_data.getString("ruta_imagen"),
...
*/
			...
			toast=activity.getString(R.string.visitas_realizadas_descargadas);
			new OperacionesDescargaRealizadasPositivas(activity,apm ).execute();
