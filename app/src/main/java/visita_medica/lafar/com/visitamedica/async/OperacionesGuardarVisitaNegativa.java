...
public class OperacionesGuardarVisitaNegativa extends AsyncTask<String, String, String>{
	...
	String link =var.function_guardar_visitas_negativas();
	String servidor;
	...
	public OperacionesGuardarVisitaNegativa(Activity act, String id_visitador)
	{
        super();
        this.activity=act;
	...
	{	super.onPreExecute();
		...
		DialogLogin.setMessage(activity.getString(R.string.guardando_visitas_negativas));
...
//servidor="si";
	...
	protected void onPostExecute(String file_url)
	{
		...
		{		
			...
			new OperacionesGuardarHistoricoActualizarEstado(activity, id_visitador).execute();
    ...
    {
        String id_historico=null;
        vc = new Visitas_controlador(activity,"visita_medica.sqlite");
        boletaje=vc.select_boletaje_where_estado_pendiete_and_estado_equals_negativo();
