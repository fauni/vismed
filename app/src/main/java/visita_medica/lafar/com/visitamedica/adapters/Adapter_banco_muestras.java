...
public class Adapter_banco_muestras extends ArrayAdapter<Tblbancomm> {
	...
	public Adapter_banco_muestras(Context context, int textViewResourceId, ArrayList<Tblbancomm> banco_muestra) {
