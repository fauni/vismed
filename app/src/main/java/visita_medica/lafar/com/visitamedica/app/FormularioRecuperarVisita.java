...
public class FormularioRecuperarVisita extends Activity {
    ...
    Calendar mas_diez_minutos;
    Calendar mas_quince_minutos;
 ...
 */
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   ArrayAdapter spinnerArrayAdapter_acompamhiado = new ArrayAdapter(this,android.R.layout.simple_spinner_dropdown_item,array_acompanhiada);
        ...
        vc = new Visitas_controlador(FormularioRecuperarVisita.this, "visita_medica.sqlite");
       ...
       File file = new File(foto);
        if(file.exists())
        {
            Toast.makeText(FormularioRecuperarVisita.this,getString(R.string.ya_existe_firma_guardada),Toast.LENGTH_SHORT).show();
            bandera_existe_foto=1;
            ruta_imagen=foto;
        }
        else
        {
            Toast.makeText(FormularioRecuperarVisita.this,getString(R.string.no_existe_firma_guardada),Toast.LENGTH_SHORT).show();
 ...
 */
        ...
        cargar_firma.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(bandera_existe_foto.equals(1))
                {
                    ...
                    new AlertDialog.Builder(FormularioRecuperarVisita.this)
                            ...
                            .setPositiveButton(getString(R.string.si), new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent i = new Intent(FormularioRecuperarVisita.this, CapturaFirma.class);
    ...
    public void actualizar_tabla()
    {
        ...
        if (detalle_visita.size() > 1) {
            Toast.makeText(FormularioRecuperarVisita.this,Codbarra+" "+ mes+" "+anhio, Toast.LENGTH_LONG).show();
                                                   ...
                                                   new AlertDialog.Builder(FormularioRecuperarVisita.this)
                                                           ...
                                                           .setPositiveButton(getString(R.string.guardar_coordenadas_ahora), new DialogInterface.OnClickListener() {
                                                               public void onClick(DialogInterface dialog, int which) {
                                                                   ...
                                                                   Intent location_find = new Intent(FormularioRecuperarVisita.this, EstoyAqui2.class);
                                                       ...
                                                       /*    .setNegativeButton(getString(R.string.guardar_coordenadas_despues), new DialogInterface.OnClickListener() {
                                                               public void onClick(DialogInterface dialog, int which) {
                                                                   ...
                                                                   if (fun.existe_error_con_id_boleta(FormularioRecuperarVisita.this, id_visita)) {
                                                                   boletaje_auxiliar = vc.select_all_boletaje_auxiliar_where_estado_guardado_pendientes();
                                                                   if (boletaje_auxiliar.size() == 0) {
                                                                       System.out.println("Noy hay iinguna tarea auxiliar pendiente");
                                                                       ...
                                                                       if (boletaje_auxiliar.size() > 0) {
                                                                           ...
                                                                           Toast.makeText(FormularioRecuperarVisita.this, getString(R.string.la_tarea_ya_fue_guardada), Toast.LENGTH_SHORT).show();
                                                                       } else {
                                                                           ...
                                                                           Toast.makeText(FormularioRecuperarVisita.this, getString(R.string.tiene_quince_minutos_para_capturar_las_coordenadas), Toast.LENGTH_SHORT).show();
                                                                       }
                                                                   } else {
                                                               ...
                                                               {
                                                                   Toast.makeText(FormularioRecuperarVisita.this, getString(R.string.visita_guardadas), Toast.LENGTH_SHORT).show();
                                                               }
    ...
    public void guardar_boletaje_auxiliar()
    {
        ...
        boletaje_auxiliar.add(new BoletajeAuxiliar(id_visita,
                ...
                mes,
                anhio,
                fps.Consultar_si_hay_registro(FormularioRecuperarVisita.this),
                "",  //estamos poniendo observaciones vacío porque esto nos va a servir para las negativas
    ...
    {
  /*  String fecha_alarma="2016-04-19 12:34:01";
    Date dateObj = null;
    try {
        dateObj = fecha.parse(fecha_alarma);
    } catch (ParseException e) {
        e.printStackTrace();
    }
    Calendar calendar = Calendar.getInstance();
...
*/
    ...
    {
       /* String fecha_guardar="2016-04-19 12:34:30";
        Date dateObj = null;
        try {
            dateObj = fecha.parse(fecha_guardar);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        Calendar calendar = Calendar.getInstance();
    ...
    public void guardar_y_salir()
    {
        ...
        tareas_realizadas.cuarto.finish();
        ficha_informacion_individual.quinto.finish();
        finish();
        intent = new Intent(FormularioRecuperarVisita.this, MenuPrincipal.class);
    ...
    public void guardar()
    {
        ...
        if(fun.existe_error_con_id_boleta(FormularioRecuperarVisita.this,id_visita)) {
            ...
            boletaje.add(new Boletaje(id_visita,
                    ...
                    anhio,
                    fps.Consultar_si_hay_registro(FormularioRecuperarVisita.this),
                    "", //observaciones solo se va a llenar en el negativo
        ...
        {
            Toast.makeText(FormularioRecuperarVisita.this,getString(R.string.cierre_la_boleta_intente_nuevamente_llame_al_departamento_de_sistemas),Toast.LENGTH_SHORT).show();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
                ...
                case 1:
                    if (resultCode == Activity.RESULT_OK && resultCode != FormularioRecuperarVisita.this.RESULT_CANCELED) {
    ...
    {
        Toast.makeText(FormularioRecuperarVisita.this,getString(R.string.vuelva_a_intentar_obtener_coordenadas),Toast.LENGTH_SHORT).show();
    }
